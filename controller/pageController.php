...
class PageController {
    ...
    public static function home($idInvite = null){
        $invites = DBModel::getAllGuestsActive();
        ...
        echo '<div class="max-w-md mx-auto mt-10 p-6 bg-white shadow rounded-xl">
            ...
            <form method="POST" action="admin">
                <div class="w-full flex gap-3 mb-3">
                    <input type="password" name="admin_password" class="input border border-blue-300 rounded-full focus:outline-none focus:ring-4 focus:ring-blue-300 px-4 py-2 transition w-full" placeholder="Clave de acceso" required>
